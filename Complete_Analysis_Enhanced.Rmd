...
We calculated P:R ratios to assess overall metabolic balance. Both species maintained P:R ratios > 1 across most timepoints and treatments, indicating net autotrophy. Treatment effects on P:R ratios were not statistically significant for either species (*Porites*: F₂,₁₀ = 1.34, p = 0.304; *Acropora*: F₂,₈ = 0.92, p = 0.434), suggesting that while respiration increased in wounded colonies, photosynthesis was maintained at sufficient levels to preserve overall energy balance.
